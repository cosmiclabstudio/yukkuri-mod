...
public class RemiliaEntity extends PassiveEntity implements IAnimatable {
    private AnimationFactory factory = GeckoLibUtil.createFactory(this);
    private static final TrackedData<String> CHARACTER = DataTracker.registerData(RemiliaEntity.class, TrackedDataHandlerRegistry.STRING);
    ...
    public PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
        return EntityRegistry.REMILIA_YUKKURI_TYPE.create(world);
    }
