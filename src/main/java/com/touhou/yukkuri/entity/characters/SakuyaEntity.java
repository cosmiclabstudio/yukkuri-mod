...
public class SakuyaEntity extends PassiveEntity implements IAnimatable {
    private AnimationFactory factory = GeckoLibUtil.createFactory(this);
    private static final TrackedData<String> CHARACTER = DataTracker.registerData(SakuyaEntity.class, TrackedDataHandlerRegistry.STRING);
    ...
    public PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
        return Yukkuri.SAKUYA_YUKKURI_TYPE.create(world);
    }
