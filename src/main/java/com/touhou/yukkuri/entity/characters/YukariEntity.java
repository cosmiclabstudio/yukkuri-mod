...
public class YukariEntity extends PassiveEntity implements IAnimatable {
    private AnimationFactory factory = GeckoLibUtil.createFactory(this);
    private static final TrackedData<String> CHARACTER = DataTracker.registerData(YukariEntity.class, TrackedDataHandlerRegistry.STRING);
    ...
    public PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
        return Yukkuri.YUKARI_YUKKURI_TYPE.create(world);
    }
