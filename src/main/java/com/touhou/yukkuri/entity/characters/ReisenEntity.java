...
public class ReisenEntity extends PassiveEntity implements IAnimatable {
    private AnimationFactory factory = GeckoLibUtil.createFactory(this);
    private static final TrackedData<String> CHARACTER = DataTracker.registerData(ReisenEntity.class, TrackedDataHandlerRegistry.STRING);
    ...
    public PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
        return EntityRegistry.REISEN_YUKKURI_TYPE.create(world);
    }
    ...
    protected SoundEvent getAmbientSound() {
        return SoundRegistry.ENTITY_USAGI_BNUUY;
    }
