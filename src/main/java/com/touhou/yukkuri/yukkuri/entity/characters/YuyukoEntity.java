...
public class YuyukoEntity extends PassiveEntity implements IAnimatable {
    private AnimationFactory factory = GeckoLibUtil.createFactory(this);
    private static final TrackedData<String> CHARACTER = DataTracker.registerData(YuyukoEntity.class, TrackedDataHandlerRegistry.STRING);
    ...
    public PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
        return Yukkuri.YUYUKO_YUKKURI_TYPE.create(world);
    }
