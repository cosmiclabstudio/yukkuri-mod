...
public class CirnoEntity extends PassiveEntity implements IAnimatable {
    private AnimationFactory factory = GeckoLibUtil.createFactory(this);
    private static final TrackedData<String> CHARACTER = DataTracker.registerData(CirnoEntity.class, TrackedDataHandlerRegistry.STRING);
